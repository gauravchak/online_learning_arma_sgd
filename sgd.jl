...
# @param _logret_matrix: Matrix of returns of each strategy
# @param windowSize: Order of the Auto-Regressive Model, i.e., the value of p in the model equation
# @param learningRate
# @param intercept: Boolean variable to select if intercept is part of model equation, i.e., if set to false the model equation won't have c in it.
# @param errorWindow: Order of the Moving-Average Model, i.e., the value of q in the model equation
...
# @output Matrix of predicted values of the signals on each date
# """ -> 
function getPredSignals( _logret_matrix::Array{Float64,2}, windowSize::Int64, learningRate::Real, intercept::Bool, errorWindow::Int64, logBias::Bool)
    nsignals = size(_logret_matrix)[2]
...
# @doc doc"""
# @Function get_signal_weights
# A wrapper function which calls getPredSignals and evalWeights

# @param _logret_matrix: 2-dimensional Array (matrix) of signals
# @param windowSize: Order of the Auto-Regressive Model, i.e., the value of p in the model equation
# @param learningRate
# @param intercept: Boolean variable to select if intercept is part of model equation, i.e., if set to false the model equation won't have c in it.
# @param errorWindow: Order of the Moving-Average Model, i.e., the value of q in the model equation
...
# """ ->
function get_signal_weights(_logret_matrix::Array{Float64,2}, windowSize::Int64, learningRate::Real, intercept::Bool, errorWindow::Int64, logBias::Bool, balancingFactor::Real)
    predSignal = getPredSignals(_logret_matrix, windowSize, learningRate, intercept, errorWindow, logBias)
